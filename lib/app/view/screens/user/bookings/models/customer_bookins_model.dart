...
class CustomerBooking {
	...
	factory CustomerBooking.fromJson(Map<String, dynamic> json) {
		return CustomerBooking(
			...
			position: json['position'] is int ? json['position'] : (json['position'] != null ? int.tryParse(json['position'].toString()) : null),
			currentPosition: json['currentPosition'] != null ? json['currentPosition'].toString() : null,
