...
class ProfessionalProfile extends StatelessWidget {
  ...
  const ProfessionalProfile({super.key, required this.data, this.userRole, required this.controller});
          ...
          child: Column(
            ...
            children: [
              Obx(() {
                ...
                final professionalData = controller.barberProfessionalProfileList.first;

                // Choose profile image from portfolio if available
                String imageUrl = professionalData.portfolio.isNotEmpty ? professionalData.portfolio.first : '';
                        ...
                        children: [
                          Row(
                            children: [
                              Icon(
                                Icons.circle,
                                size: 12,
                                color: professionalData.isAvailable ? Colors.greenAccent : Colors.redAccent,
                              ),
                              const SizedBox(width: 6),
                              CustomText(
                                text: professionalData.isAvailable ? 'Available' : 'Not available',
                                fontSize: 14,
                          ...
                          Row(
                            children: [
                              ...
                              const SizedBox(width: 6),
                              CustomText(
                                text: '${professionalData.avgRating.toStringAsFixed(1)} (${professionalData.ratingCount})',
                                fontSize: 14,
                                color: AppColors.black,
                              ),
                            ],
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                        ...
                        return Row(
                          ...
                          children: [
                            CommonProfileTotalCard(
                              title: 'Rating',
                              value: '${professionalData.avgRating.toStringAsFixed(1)} (${professionalData.ratingCount})',
                            ),
                            SizedBox(width: 8),
                            CommonProfileTotalCard(
                      ...
                      Obx(() {
                        if (controller.isBarberProfessionalProfileLoading.value) return const SizedBox.shrink();
                        final professionalData = controller.barberProfessionalProfileList.first;
