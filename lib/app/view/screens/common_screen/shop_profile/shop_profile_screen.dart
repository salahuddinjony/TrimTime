...
class ShopProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      final selonData = controller.selonList.isNotEmpty ? controller.selonList.first : null;
      final isFollowing = selonData?.isFollowing ?? false;
      return Scaffold(
                        ...
                        Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              CustomText(
                                text: selonData?.shopName ?? "No Shop Data",
                                fontSize: 18,
                              ...
                              Row(
                                ...
                                children: [
                                  _customButton(isFollowing ? "Unfollow" : "Follow", Icons.person_add, controller),
  ...
  Widget _customButton(String text, IconData icon, BarberHomeController controller) {
    return GestureDetector(
      onTap: () {
        // You can implement follow/unfollow logic here using controller
        // For example: controller.toggleFollow();
      },
      child: Container(
